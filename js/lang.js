var langeng = {
    ...
    "certificate-para-1": "Here, we can write something about the certificate, that it makes the company is awesome and you can now order from us fakuj itemsków, and the diploma can print and hang on the wall, well, this is a great case in general this certificate",
...
var langpl = {
    ...
    "info-para-4": "Zapraszamy Państwa do nadsyłania zapytań ofertowych.",
    "about": "o nas",
    "offer": "oferta",
    "certificate": "certyfikat jakości",
    "contact": "kontakt",
    "pollang": "polski",
    "englang": "angielski",
    "hello-certificate": "Certyfikat jakości",
    "certificate-para-1": "Tutaj możemy coś napisać o certyfikacie, że to sprawia że firma jest zajebista i w ogóle możecie teraz zamawiać u nas fchuj itemków, a dyplom można sobie wydrukować i powiesić na ścianie, no świetna sprawa generalnie ten certyfikat",
    "hello-offer": "Nasza oferta obejmuje:",
    "ul-1": "WYROBY WALCOWANE w postaci:",
    "ul-2": "WYROBY CIĄGNIONE w postaci:",
    "ul-3": "WYROBY STALOWNI w postaci:",
    "ul-4": "ODKUWKI SWOBODNIE KUTE w postaci:",
    "ul-5": "ODKUWKI MATRYCOWE w postaci:",
    "ul-6": "MIELNIKI w postaci:",
    "ul-1-1": "pręty okrągłe (z przeznaczeniem do obróbki wiórowej oraz do kucia)",
    "ul-1-2": "kęsy i kęsiska kwadratowe",
    "ul-1-3": "pręty płaskie",
    "ul-1-4": "blachy gorącowalcowane",
    "ul-2-1": "pręty okrągłe",
    "ul-2-2": "pręty sześciokątne",
    "ul-2-3": "pręty kwadratowe",
    "ul-2-4": "pręty płaskie",
    "ul-3-1": "pręty okrągłe płaskie i kwadratowe",
    "ul-3-2": "krązki",
    "ul-3-3": "pierścienie",
    "ul-3-4": "kostki i płyty",
    "ul-3-5": "odkuwki kształtowe",
    "ul-4-1": "wlewki kuzienne",
    "ul-4-2": "kąsiska COS",
    "ul-5-1": "o masie jednostkowej od 0,2 kg do 49 kg z możliwością prowadzenia obróbki cieplnej",
    "ul-5-2": "kule mielące",
    "ul-6-1": "kuże",
    "ul-6-2": "pręty",
    "hello-contact": "Skontaktuj się z nami !"
}